        ...
        <div class="col-lg-8">
            <div class="glass-card p-4 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control form-control-custom @error('description') is-invalid @enderror" id="description" name="description" rows="4">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="glass-card p-4">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-custom @error('sku') is-invalid @enderror" id="sku" name="sku" value="{{ old('sku') }}">
                            <button class="btn btn-outline-secondary" type="button" id="generateSku">Generate</button>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-custom @error('barcode') is-invalid @enderror" id="barcode" name="barcode" value="{{ old('barcode') }}">
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <label for="current_stock" class="form-label fw-semibold">Initial Stock</label>
                        <input type="number" min="0" class="form-control form-control-custom @error('current_stock') is-invalid @enderror" id="current_stock" name="current_stock" value="{{ old('current_stock', 0) }}">
                        @error('current_stock')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="number" min="0" class="form-control form-control-custom @error('low_stock_threshold') is-invalid @enderror" id="low_stock_threshold" name="low_stock_threshold" value="{{ old('low_stock_threshold', 10) }}">
