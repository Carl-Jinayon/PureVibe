            ...
            <div class="glass-card p-4">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control form-control-custom @error('unit_price') is-invalid @enderror" id="unit_price" name="unit_price" value="{{ old('unit_price', $product->unit_price) }}" required>
                        @error('unit_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
